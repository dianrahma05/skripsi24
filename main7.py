...
class DataMining:
    ...
    def menu_data_mining(self):
        if "train_df" in st.session_state:
            ...
            pekerjaan_list = ['TIDAK BEKERJA', 'BURUH HARIAN LEPAS', 'KARYAWAN SWASTA', 'WIRASWASTA', 'PEDAGANG', 'PETERNAK']
    ...
    def make_prediction(self):
        if "preprocessed_data" in st.session_state and "model" in st.session_state:
            ...
            if uploaded_file:
                ...
                required_columns = set(st.session_state.preprocessed_data.columns)
                if set(data.columns).issubset(required_columns):
                    # Transformasi data menggunakan preprocessor yang telah disimpan
                    ...
                    data['Prediksi Status Kelayakan'] = predictions
                    
                    # Menampilkan hasil prediksi
                    st.subheader("Hasil Prediksi")

                    # Fungsi untuk mengekspor DataFrame ke Excel
                    def export_to_excel(df):
                        ...
                        with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
                            ...
                            # Set header format biasa (tanpa penebalan)
                    ...
                    # Tombol untuk mengunduh file Excel dengan hasil prediksi
                    excel_data = export_to_excel(data[['Nama_KRT', 'Prediksi Status Kelayakan']])
                    st.download_button(
                    ...
                    # Menampilkan nama dan prediksi dalam tabel
                    st.write(data[['Nama_KRT', 'Prediksi Status Kelayakan']])
